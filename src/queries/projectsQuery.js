...
export async function fetchRepos() {
  ...
  const projects = new Map([
    ['MDEwOlJlcG9zaXRvcnk4MTM4NjM5Mg==', { displayName: 'Jimmy\'s Home Page', screenshot: JimmyHomePage }],
    ['MDEwOlJlcG9zaXRvcnk4MTQ4MTM4Nw==', { displayName: 'Card Games', screenshot: CardGamesScreenshot }],
    ['MDEwOlJlcG9zaXRvcnk3NDA5ODIyNw==', { displayName: 'Houdana', screenshot: HoudanaScreenshot }],
    ['MDEwOlJlcG9zaXRvcnkxMDA0MjI3Mjk=', { displayName: 'Free Code Camp', screenshot: FreeCodeCampScreenshot }],
    ['MDEwOlJlcG9zaXRvcnk4MTQ3Nzg5OA==', { displayName: 'List Generator', screenshot: LabelCreatorScreenshot }],
  ]);
