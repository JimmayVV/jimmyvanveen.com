...
export default function Projects() {
  ...
  const { data: projectsData, status, error } = useQuery(
    "projects",
    () => fetchRepos(),
    queryArgs,
  )
  ...
  if (error)
    return (
      <div className="wrapper">
        <div className="inner">
          There was trouble loading project data from GitHub
        </div>
      </div>
    )
    ...
    <section id="four" className="wrapper alt style1">
      <div className="inner">
        ...
        <p>
          ...
          While many of these projects are quite old at this point, some may be
          more recent. Feel free to take any inspiration you wish from these
          codebases.
        </p>
